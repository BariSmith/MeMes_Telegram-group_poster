...
class ChanItems:
    ...
    def __init__(self, data: dict, channel_id: str, limit: int):
...
class ApiWorker:
    ...
    def get_items(self, channel_id: str, limit: int=1, next_id: Optional[str]=None, prev_id: Optional[str]=None) -> ChanItems:
        params = []
        if limit:
        ...
        return ChanItems(self.__make_request(url=url), channel_id, limit)

    def get_recomendations(self, limit: int=1) -> List[PostItem]:
